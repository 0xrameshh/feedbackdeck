...
const plans = [
  ...
  },
  {
    ...
    popular: true,
    cta: "Start Free Trial",
    polarProductId: "professional-plan",
  },
  {
    name: "Enterprise",
    price: "$99",
    ...
    popular: false,
    cta: "Contact Sales",
    polarProductId: "enterprise-plan",
  },
];
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Everything you need to know about FeedbackDeck pricing.
              </p>
            </div>
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Collect valuable feedback from your users with FeedbackDeck.
            </p>
            <Link href="/auth">
